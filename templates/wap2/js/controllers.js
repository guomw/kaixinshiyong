  ...
  .controller('Userhome', ['$rootScope','$scope','$ionicLoading', '$state', 'StorageFactory', 'UserPersonalFactory','qiandaoFactory',function($rootScope,$scope,$ionicLoading, $state, StorageFactory, UserPersonalFactory,qiandaoFactory) {
