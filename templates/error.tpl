...
.showMsg .ok,.showMsg .guery, .showMsg .error{background: url(<?php echo IMG_PATH; ?>msg_img/msg_bg.png) no-repeat 0px -560px;}
...
<div class="showMsg" style="text-align:center">
    ...
    <div class="bottom">
    	<a href="<?php echo($jumpUrl); ?>" id="href">[点这里返回上一页，<b id="wait"><?php echo($waitSecond); ?></b>秒后自动跳转]</a>
			        </div>
</div>
