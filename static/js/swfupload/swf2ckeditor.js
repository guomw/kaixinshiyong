function flashupload(uploadid, name, textareaid, funcName, args, module, catid, authkey) {
	...
	window.top.art.dialog({
		title:name,
		id:uploadid,
		iframe:'index.php?m=Attachment&c=Attachment&a=swfupload'+args+setting,width:'500',height:'420'
	}, function() {
		if(funcName) {
...
function insert2editor(id,in_content,del_content) {	
	...
	$.get("index.php?m=attachment&c=attachment&a=swfdelete",{data: del_content},function(data){});
