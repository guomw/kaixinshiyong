...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		...
		<td>
			<select name="link[typeid]" id="typeid">
	...
	<tr>
		...
		<td><input type="text" name="link[webname]" id="link_name"size="30" class="input-text"></td>
	</tr>
	...
	<tr id="logolink">
		...
		<td><?php echo $form::images('link[image]', 'image', $image, 'document');?></td>
	</tr>
	
	<tr>
		<th width="100"><?php echo L('username')?>：</th>
		<td><input type="text" name="link[userid]" id="link_username"
			size="30" class="input-text" value="<?php echo session('userid');?>"></td>
	</tr>
	...
	<tr>
		...
		<td><input name="link[display]" type="radio" value="1" >&nbsp;<?php echo L('yes')?>&nbsp;&nbsp;<input
			name="link[display]" type="radio" value="0" checked>&nbsp;<?php echo L('no')?></td>
	</tr>
	<tr>
