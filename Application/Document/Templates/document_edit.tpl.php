...
?>
 ...
 if($rs == 0){
 ?>
<span class="ib" style="width:90px"><label><input type="radio" name="info[status]" value="1"  checked /> <?php echo L('c_publish');?> </label></span>
<label><input type="radio" name="info[status]" value="0"> <?php echo L('passed');?> </label>
<?php 
 }else{
?>
<span class="ib" style="width:90px"><label><input type="radio" name="info[status]" value="1"/> <?php echo L('c_publish');?> </label></span>
<label><input type="radio" name="info[status]" value="0" checked> <?php echo L('passed');?> </label>
 <?php 
 }
 ?>
...
<div class="fixed-bottom">
	...
	<input value="<?php echo $catid;?>" type="hidden" name="catid">
	<input value="<?php echo L('save_close');?>" type="submit" name="dosubmit" class="cu" onclick="refersh_window()"></div>
