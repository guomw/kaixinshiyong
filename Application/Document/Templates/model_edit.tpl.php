...
<fieldset>
  ...
  <th width="200"><?php echo L('available_styles');?></th>
	...
	<tr> 
      ...
      <?php echo $form::select_template($default_style,'document', $category_template, 'name="setting[category_template]" id="template_category"', 'category')?></td>
    </tr>
	<tr> 
      <th ><?php echo L('category_list_tpl');?></th>
      <td id="list_template"><?php echo $form::select_template($default_style,'document', $list_template, 'name="setting[list_template]" id="template_list"', 'list')?></td>
    </tr>
	<tr> 
      <th><?php echo L('content_tpl');?></th>
      <td id="show_template"><?php echo $form::select_template($default_style,'document', $show_template, 'name="setting[show_template]" id="template_show"','show')?></td>
    </tr>
</table>
</fieldset>
<div class="bk15"></div>
