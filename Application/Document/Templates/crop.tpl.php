...
// 上传地址，使用了 base64 加密
flashvars.uploadurl = "<?php echo base64_encode(U('Attachment/Attachment/crop_upload', array('module' => $module, 'catid' => $catid, 'file'=>urlencode($picurl))));?>";
var params = {};
params.quality = "high";
...
swfobject.embedSWF("<?php echo JS_PATH?>crop/images/Main.swf", "flashContent", "680", "480", swfVersionStr, xiSwfUrlStr, flashvars, params, attributes);
