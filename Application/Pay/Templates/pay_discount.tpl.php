...
<form name="myform" action="<?php echo U('discount');?>" method="post" id="myform">
<table width="100%" class="table_form">
<tr>
<td  width="80"><?php echo L('order_sn')?></td> 
<td><?php echo $pay_discount['ordid']?></td>
</tr>
<tr>
<td><?php echo L('order_discount')?></td> 
<td><input type="text" name="discount" value="<?php echo $pay_discount['discount'] ? $pay_discount['discount'] : 0 ?>" class="input-text" id="discount" size="6"> <?php echo L('yuan')?>
</td>
</tr>
</table>
<input type="hidden"  name="id" value="<?php echo $pay_discount['orderid']?>" />
