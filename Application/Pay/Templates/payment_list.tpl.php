                        ...
                        <tr>
                            ...
                            <td width="15%" align="center">
                                <?php if ($info['enabled']) { ?>
                                    ...
                                    <!--<a href="javascript:confirmurl('<?php echo U('delete', array('id' => $info['pay_id'])) ?>', '<?php echo L('confirm', array('message' => $info['pay_name'])) ?>')"><?php echo L('plus_uninstall') ?></a>
    -->
                                <?php } else { ?>
                                    <!-- 安装 -->
...
<script type="text/javascript">
    ...
    function add(id, name) {
        window.top.art.dialog({
            ...
            id: 'add',
            iframe: '?m=Pay&c=Pay&a=add&code=' + id,
            width: '700',
            height: '500'
        }, function () {
    ...
    function edit(id, name) {
        window.top.art.dialog({
            title: '<?php echo L('edit')?>--' + name,
            id: 'edit',
            iframe: '?m=Pay&c=Pay&a=edit&id=' + id,
            width: '700',
            height: '500'
        }, function () {
