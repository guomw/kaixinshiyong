    	...
    	<td>
    		<div class="explain-col">	
				...
				<input type="submit" name="searchbtn" class="button" value="<?php echo L('search');?>" />
						<br><br>
				提现完成总金额:<font color="green"><?php echo $cash_success; ?></font>&nbsp;&nbsp;&nbsp;
				提现申请总金额：<font color="green"><?php echo $cash_apply; ?></font>&nbsp;&nbsp;&nbsp;
				提现失败总金额：<font color="green"><?php echo $cash_failure; ?></font>&nbsp;&nbsp;&nbsp;
...
<div class="table-list">
    <table width="100%">
		...
		<tr>
            <!-- <th width="37">排序</th> -->
            <th width="40">ID</th>
			<th  width="100">今日提现完成金额</th>
			<th width="100">今日申请提现金额</th>
			<th width="100">今日提现失败金额</th>
        ...
        <tr>
			...
			<td align='center' ><?php echo sprintf('%.2f',$r['cash_success']);?></td>
			<td align='center'><?php echo sprintf('%.2f',$r['day_cash_Apply']); ?></td>
			<td align='center'><?php echo sprintf('%.2f',$r['day_cash_Failure']); ?></td>
