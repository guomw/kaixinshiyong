...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['name']    = '网银在线';   
    $modules[$i]['desc']    = '网银在线与中国银行、中国工商银行、中国农业银行、中国建设银行、招商银行等国内各大银行，以及VISA、MasterCard、JCB等国际信用卡组织保持了长期、紧密、良好的合作关系。<a href="http://www.chinabank.com.cn/?pc_hash=BpkkbR" target="_blank"><font color="red">立即在线申请</font></a>';
    $modules[$i]['is_cod']  = '0';
