...
<table width="100%" cellspacing="0" class="table_form">
    ...
    <tr>
		<th>投放渠道：</th>
		<td>
			<label class="ib " style=""><input type="checkbox" <?php if (in_array(1, $c_types)) {?> checked <?php } ?>value="1" name="info[c_type][]">pc端&nbsp;</label>
			<label class="ib " style=""><input type="checkbox" <?php if (in_array(2, $c_types)) {?> checked <?php } ?>  value="2" name="info[c_type][]">手机端&nbsp;</label>
	...
	<tr>
		...
		<td><input type="text" name="info[activity_days]" id="activity_days" class="input-text" value="<?php echo $rs['activity_days'] ?>" <?php if ($rs['status'] > -3) {
			?> disabled  <?php } ?> style="width: 50px;"/>天，从活动上线开始持续开放的活动时间。</td>
	</tr>
		...
		<td>
			<fieldset class="blue pad-10">
				...
				<div id="goods_search_albums" class="picList">
					<?php foreach ($goods_albumss as $pic): ?>
					<?php $k = random(6); ?>
