...
?>
<div class="pad-10">
<form method="post" action="<?php echo U('add');?>" name="myform" id="myform">
<table class="table_form" width="100%" cellspacing="0">
<tbody>
	<tr>
		<th width="80"><strong><?php echo L('announce_type')?></strong></th>
		<td>
			<input name="announce[type]" id="type" class="input-text" type="radio" value="0" checked>普通公告
			<input name="announce[type]" id="type" class="input-text" type="radio" value="1">商家公告
			<input name="announce[type]" id="type" class="input-text" type="radio" value="2">招商公告
			<input name="announce[type]" id="type" class="input-text" type="radio" value="3">官方公告
			<input name="announce[type]" id="type" class="input-text" type="radio" value="5">VIP公告
		</td>
	</tr>
	<tr>
...
$(document).ready(function(){
	...
	$('#title').formValidator({
		...
		type:"get",
		url:"",
		data:"m=announce&c=announce&a=public_check_title",
		datatype:"json",
		cached:false,
		async:'true',
