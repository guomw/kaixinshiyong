...
<tbody>
	<tr>
		...
		<td>
			<input name="announce[type]" id="type" class="input-text" type="radio" value="0" checked>普通会员
			<input name="announce[type]" id="type" class="input-text" type="radio" value="1">商家会员
		</td>
	</tr>
	<tr>
		<th width="80"><strong>文章分类</strong></th>
