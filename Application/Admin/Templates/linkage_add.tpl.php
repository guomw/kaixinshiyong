...
<td>
<input name="info[style]" value="0" checked="checked" type="radio">&nbsp;<?php echo L('drop_down_style')?>&nbsp;&nbsp;<input name="info[style]" value="1" type="radio">&nbsp;<?php echo L('pop_style')?>&nbsp;&nbsp;<input name="info[style]" value="2" type="radio">&nbsp;联动菜单,显示&nbsp;<input type="text" name="info[level]" value="" class="input-text" id="level" size="5">&nbsp;级
</td>
</tr>
</table>
    <div class="bk15"></div>
