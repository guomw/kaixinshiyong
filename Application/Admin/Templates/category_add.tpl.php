 ...
 <tr>
     <th><?php echo L('add_category_types');?>：</th>
        ...
        <td>
		 <?php
				...
				foreach($models as $_k=>$_v) {
					if($_v['disabled'] == 1 || $_v['module'] != 'document') continue;
					$model_datas[$_k] = $_v['name'];
				}
      ...
      <tr>
        ...
        <td>
		<?php echo $form::select_category($parentid,'name="info[parentid]" id="parentid"',L('please_select_parent_category'),0,-1);?>
		</td>
      </tr>
