...
<td><input type="text" name="info[title]" class="input-text" value="<?php echo $rs['title']?>" id="title" size="40"></input></td>
</tr>
<tr>
<td><?php echo L('posid_thumb')?></td> 
<td><?php echo $form::images('info[thumb]','thumb',$rs['thumb'],'content')?> </td>
</tr>
<tr>
<td><?php echo L('posid_inputtime')?></td> 
<td><?php echo $form::date('info[inputtime]', date('Y-m-d h:i:s',$rs['inputtime']), 1)?></td>
</tr>

<tr>
<td><?php echo L('posid_desc')?></td> 
<td>
<textarea name="info[description]" rows="2" cols="20" id="description" class="inputtext" style="height:100px;width:300px;"><?php echo $rs['description']?></textarea>
</td>
</tr>
<tr>
<td><?php echo L('posid_syn')?></td> 
<td>
<input name="synedit"  value="0" type="radio" <?php echo $synedit==0 ? 'checked="checked"' : ''?>> 开启<input name="synedit" value="1" type="radio" <?php echo $synedit==1 ? 'checked="checked"' : ''?>> 关闭        
</td>
</tr>
