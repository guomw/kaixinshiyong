...
<input name="info[style]" value="2" type="radio" <?php if($style==2) {?>checked<?php }?>>&nbsp;联动菜单,显示&nbsp;<input type="text" name="info[level]" value="<?php echo $setting['level']?>" class="input-text" id="level" size="5">&nbsp;级
<input type="hidden" name="linkageid" value="<?php echo $linkageid?>">
