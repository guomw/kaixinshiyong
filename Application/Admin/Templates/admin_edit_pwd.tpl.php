...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#old_password").formValidator({empty:true,onshow:"<?php echo L('not_change_the_password_please_leave_a_blank')?>",onfocus:"<?php echo L('password').L('between_5_to_20')?>",oncorrect:"<?php echo L('old_password_right')?>"}).inputValidator({min:5,max:20,onerror:"<?php echo L('password').L('between_5_to_20')?>"}).ajaxValidator({
	    type : "get",
