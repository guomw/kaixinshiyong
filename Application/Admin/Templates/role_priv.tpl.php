...
<form name="myform" action="<?php echo U('role_priv') ?>" method="post">
...
<center>
	<div class="guery" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;">请选择管理员角色</div>
</center>
<?php }?>
