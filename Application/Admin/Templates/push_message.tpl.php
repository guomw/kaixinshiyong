        ...
        <tr>
                ...
                <td class="y-bg">
                    <label><input type="radio" id="id_recipient_type_0" class="input-text" name="push[recipient_type]" value="1" checked="checked"/> 广播(所有人)&nbsp;</label>
                     ...
                     <label><input type="radio" id="id_recipient_type_2" class="input-text" name="push[recipient_type]" value="3"/>用户id(Alias)&nbsp;</label>&nbsp;
             ...
             <tr  class="activity_mold_hint2" style="display:none;">
                ...
                <td class="y-bg">
                     ...
                     <input type="text" class="input-text " name="push[device_alias]" value="" index="2" placeholder="输入用户id，多个,分割" />&nbsp;
