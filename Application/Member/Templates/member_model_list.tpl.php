...
?>
    <tr>
		...
		<td align="center">
		<a onclick="_M(98);" href="<?php echo U('MemberModelfield/manage', array('modelid' => $v['modelid'], 'menuid' => 98)); ?>"><?php echo L('field').L('manage')?></a> | <a href="javascript:edit(<?php echo $v['modelid']?>, '<?php echo $v['name']?>')"><?php echo L('edit')?></a> | <a href="<?php echo U('export', array('modelid' => $v['modelid'])) ?>"><?php echo L('export')?></a> | <a href="javascript:move(<?php echo $v['modelid']?>, '<?php echo $v['name']?>')"><?php echo L('move')?></a>
		</td>
    </tr>
<?php
	}
...
<input type="submit" class="button" name="dosubmit" onclick="document.myform.action='<?php echo U('public_listorder');?>'" value="<?php echo L('sort')?>"/>
</div> 
