...
<fieldset>
	<legend><?php echo L('member_aword');?></legend>
	<table width="100%" class="table_form">
		<tr>
			<td width="120"><?php echo L('member_aword_type')?></td> 
			<td>
				<label><input type="radio" name="info[type]" value="0" checked>成长值</label>&nbsp;&nbsp;
				<label><input type="radio" name="info[type]" value="1">积分</label>&nbsp;&nbsp;
				<label><input type="radio" name="info[type]" value="2">现金</label>
			</td>
		</tr>
		<tr>
