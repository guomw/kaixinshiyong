    ...
    <div class="col-tab">
        ...
        <table width="100%"  class="table_form">
            <tr>
                <th>Push Key</th>
                <td class="y-bg">
                    <input type="text" class="input-text" name="setting[push_key]" value="<?php echo C('push_key')?>"/>&nbsp;
                </td>
            </tr>
            ...
            <tr>
                <th>Push Secret</th>
                <td class="y-bg">
                    <input type="text" class="input-text" name="setting[push_secret]" value="<?php echo C('push_secret') ?>"/>&nbsp;
                </td>
            </tr>
