...
?>
<div class="pad-lr-10">
<form name="searchform" action="<?php echo U('search_message') ?>" method="post" >
...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center"><?php echo $info['messageid']?></td>
		<td><?php echo $info['subject']?></td>
		<td align="" widht="35%"><?php echo $info['content'];?></td>
		<td align="center" width="10%"><?php echo dhtmlspecialchars($info['username'])?dhtmlspecialchars($info['username']):"无";?></td>
		<td align="center" width="10%"><?php echo dhtmlspecialchars($info['nickname'])?dhtmlspecialchars($info['nickname']):"无昵称";?></td>
		<td align="center" width="15%"> <a
			href='<?php echo U('delete', array('messageid' => $info['messageid'])) ?>'
