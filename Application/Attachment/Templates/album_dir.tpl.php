...
<?php if ($dir !='' && $dir != '.'):?>
<tr>
<td align="left"><a href="<?php echo U('album_dir', array('dir' => stripslashes(dirname($dir))));?>"><img src="<?php echo IMG_PATH?>folder-closed.gif" /><?php echo L("parent_directory")?></td></a>
</tr>
<?php endif;?>
<?php 
if(is_array($list)):
...
<tr>
<?php if (is_dir($v)) {
	echo '<td align="left"><img src="'.IMG_PATH.'folder-closed.gif" /> <a href="'.U('album_dir', array('dir' => (isset($_GET['dir']) && !empty($_GET['dir']) ? stripslashes($_GET['dir']).'/' : '').$filename)).'"><b>'.$filename.'</b></a></td>';
} else {
