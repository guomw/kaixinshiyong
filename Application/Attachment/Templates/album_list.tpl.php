...
function album_cancel(obj,id,source){
	...
	if($(obj).hasClass('on')){
		...
		var strs = filenames = '';
		$.get('index.php?m=attachment&c=attachment&a=swfupload_json_del&aid='+id+'&src='+source);
		...
		$(obj).addClass("on");
		$.get('index.php?m=attachment&c=attachment&a=swfupload_json&aid='+id+'&src='+source);
